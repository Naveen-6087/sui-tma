 ...
 *
 * Works in TWO modes:
 *   1. Telegram Mini App (opened from inline keyboard) — gets chatId+sig from URL params
 *   2. Standalone web page (opened from browser link) — same URL params
 *
 * Uses @hot-labs/near-connect for the wallet selector.
 * After wallet connects, calls /api/telegram/link to store the link server-side
 * and notify the user in Telegram.
 *
 * Does NOT use WebApp.sendData() — that only works with reply keyboard buttons,
 * not inline keyboard web_app buttons.
 */
...
function ConnectWalletContent() {
  ...
  }, [chatId, sig, accountId, isTelegram]);
