...
URL: https://docs.sui.io/standards/deepbookv3-indexer
...
Each poolobject <strong class="text-primary">Object</strong> The basic unit of storage on Sui. in the response includes the following fields:
...
• [DeepBookV3 repository](https://github.com/MystenLabs/deepbookv3) The DeepBookV3 repository on GitHub.  what data i can get from indexer 